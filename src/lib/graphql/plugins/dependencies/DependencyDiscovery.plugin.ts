 ...
 * manifests. It reads package.json, Cargo.toml, go.mod, and requirements.txt at
 * the default branch, resolves each dependency to another repository the owner
 * holds (an edge) or an external package, and replaces the repository's previous
 * manifest-detected rows. This makes the polyrepo graph self-maintaining.
 *
